...
export default {
    ...
    async created() {
        ...
        await axios.get(`/api/product/${this.$route.params.id}`)
        .then(response => {
    ...
    methods: {
        ...
        async update() {
            ...
            await axios.post(`/api/update-product/${this.product.id}`, fd,
                {
                    headers: {
                ...
                await axios.post(`/api/store-product-details/${this.product.id}`, {
